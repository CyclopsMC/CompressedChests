package org.cyclops.compressedchests;
...
@Mod(
        ...
        guiFactory = "org.cyclops.compressedchests.GuiConfigOverview$ExtendedConfigGuiFactory",
        certificateFingerprint = Reference.MOD_FINGERPRINT
)
public class CompressedChests extends ModBaseVersionable {
    
    /**
     * The proxy of this mod, depending on 'side' a different proxy will be inside this field.
     * @see SidedProxy
     */
    @SidedProxy(clientSide = "org.cyclops.compressedchests.proxy.ClientProxy", serverSide = "org.cyclops.compressedchests.proxy.CommonProxy")
    ...
    public static CompressedChests _instance;

    public CompressedChests() {
    ...
    public static void clog(Level level, String message) {
        CompressedChests._instance.getLoggerHelper().log(level, message);
    }
